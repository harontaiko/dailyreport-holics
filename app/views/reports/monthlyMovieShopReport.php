<section id="reports-tbl">
    ...
    <h1 id="report-title">Monthly Movieshop <span>Report</span></h1>
    ...
    <table class="responstable" id="responstable">
        ...
        $m = getMovieshopAllMonthNet($data['db']);
    ...
    <table>
        ...
        <tfoot>
            <tr>
             ...
             echo number_format(getMovieshopTotalMonth($data['db'])); ?></td>
            </tr>
        </tfoot>
    </table>
...
$(document).ready(function() {
    $.ajax({
        url: `http://localhost/dailyreport-holics/pages/getMovieShopRepoMonth`,
        type: "GET",
        dataType: "json",
