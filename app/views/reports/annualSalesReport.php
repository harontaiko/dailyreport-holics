<section id="reports-tbl">
    ...
    <h1 id="report-title">Annual Sales <span>Report</span></h1>

    <table class="responstable" id="responstable">

        <tr>
            <th>Year</th>
            <th>Annual Sales Amount (Ksh)</th>
            <th>Annual Profit (Ksh)</th>
        </tr>

        <?php 
        
        $m = getSalesAllYearNet($data['db']);
        ...
        <tr>
            ...
            <td style="color: black;"><?php echo number_format($mv['profit_net']); ?></td>
            </td>
        </tr>
        <?php endwhile; ?>
    </table>
...
<div class="container-out-report" id="container-out-report2">
    ...
    <section id="realtime-charts">
        <div class="line-chart-report">
            <h2 style="font-size: large;">6 Most Sold Items This Year</h2>
...
$(document).ready(function() {
    $.ajax({
        url: `http://localhost/dailyreport-holics/pages/getSalesRepoYear`,
        type: "GET",
        dataType: "json",
            ...
            if (dataResult.statusCode == 200) {
                ...
                var pieChartReport = new Chart(pieChart, {
                    ...
                    data: {
                        ...
                        datasets: [{
                            label: 'Most Sold Items This Year',
