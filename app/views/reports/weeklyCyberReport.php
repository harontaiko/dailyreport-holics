<section id="reports-tbl">
    ...
    <h1 id="report-title">Weekly Cyber <span>Report</span></h1>
    ...
    <table>
        ...
        <tfoot>
            <tr>
                ...
                <td></td>
                <td>Weekly total: <?php
             echo number_format(getCyberTotalWeek($data['db'])); ?></td>
            </tr>
        </tfoot>
    </table>
...
$(document).ready(function() {
    $.ajax({
        url: `http://localhost/dailyreport-holics/pages/getCyberRepoWeek`,
        type: "GET",
        dataType: "json",
