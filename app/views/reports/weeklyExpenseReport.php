<section id="reports-tbl">
    ...
    <h1 id="report-title">Weekly Expense <span>Report</span></h1>
    ...
    <table class="responstable" id="responstable">
        ...
        $m = getExpenseAllWeekNet($data['db']);
...
$(document).ready(function() {
    $.ajax({
        url: `http://localhost/dailyreport-holics/pages/getExpenseRepoWeek`,
        type: "GET",
        dataType: "json",
