<section id="reports-tbl">
    ...
    <h1 id="report-title">Annual Cyber <span>Report</span></h1>
    ...
    <table>
        ...
        <tfoot>
            <tr>
                ...
                <td></td>
                <td>Annual total: <?php
                     echo number_format(getCyberTotalYear($data['db'])); ?></td>
            </tr>
        </tfoot>
    </table>
...
$(document).ready(function() {
    $.ajax({
        url: `http://localhost/dailyreport-holics/pages/getCyberRepoYear`,
        type: "GET",
        dataType: "json",
