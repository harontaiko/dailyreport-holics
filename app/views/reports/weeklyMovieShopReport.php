<section id="reports-tbl">
    ...
    <h1 id="report-title">Weekly Movieshop <span>Report</span></h1>
    ...
    <table class="responstable" id="responstable">
        ...
        $m = getMovieshopAllWeekNet($data['db']);
...
$(document).ready(function() {
    $.ajax({
        url: `http://localhost/dailyreport-holics/pages/getMovieShopRepoWeek`,
        type: "GET",
        dataType: "json",
