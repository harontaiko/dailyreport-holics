...
<body class="activity __activity">
    <div class="center">
        <?php while($user = $data['row']->fetch_assoc()): ?>
        <div class="card">
            <div class="additional">

                <div class="user-card">
                    <div class="level center">
                        Logins:<?php echo getLoginCounts($user['user_id'], $data['db']) ?>
                    </div>
                    <div class="points center">
                        Last Ip Adress:<?php echo getLastIp($user['user_id'], $data['db']) ?>
                    </div>
                    <svg width="110" height="110" viewBox="0 0 250 250" xmlns="http://www.w3.org/2000/svg" role="img"
                        aria-labelledby="title desc" class="center">
                        <title id="title">Teacher</title>
                        <desc id="desc">Cartoon of a Caucasian woman smiling, and wearing black glasses and a purple
                ...
                <div class="more-info">
                    ...
                    <div class="coords">
                        <span>Admin</span>
                        <span>Joined :<?php echo $user['date_created']; ?></span>
                    </div>
                    <div class="coords">
                        <span>Info</span>
