...
<body class="cashReceipt __cashReceipt site-wrap">
    ...
    <div class="betslip-container" id="betslip-container">
        ...
        <div class="betslip-submit">
            <button class="betslip-submit-button"> Confirm And Save</button>
        </div>
        <I class="fas fa-print" style="cursor:pointer;float:right;"
